...
QRsymbol.src = 'https://en.wikipedia.org/wiki/QR_code#/media/File:QR_code_for_mobile_English_Wikipedia.svg';

mapboxgl.accessToken = 'pk.eyJ1IjoiZ2lzZmVlZGJhY2siLCJhIjoiY2tzNno0d2JjMDJpaTJ1bjA3bnRtdHMzbiJ9.i7UvPZAAwdp9h7_R558ETg';
...
map.on('load', function () {
        ...
        "features": [
            {
                ...
                "geometry": {
                    "type": "Polygon",
                    "coordinates": [[[144.9, -37.787], [145.0, -37.787], [145.0, -37.836], [144.9, -37.836], [144.9, -37.787]]]
                }
            }
        ]
    };
        ...
        "features": [
            {
                ...
                "geometry": {
                    ...
                    "coordinates": [[
                        ...
                        [144.974170, -37.8020], // Top of carlton gardens
        ...
        map.addLayer({
            ...
            'paint': {
                'fill-color':
                    ['match',
                        ['get', 'XGROUPNAME'],
                        'Heathy Woodlands', '#77A481', // WOODLANDS deep green     
                        'Plains Woodlands or Forests', '#77A481', // WOODLANDS deep green   
                        'Riverine Grassy Woodlands or Forests', '#77A481', // WOODLANDS deep green     
                        'Herb-rich Woodlands', '#77A481', // WOODLANDS deep green 
                        'Lower Slopes or Hills Woodlands', '#D3D29C', // GRASSLANDS tan 
                        'Riparian Scrubs or Swampy Scrubs and Woodlands', '#AED694', // SCRUBLANDS // mid green  
                        'Plains Grasslands and Chenopod Shrublands', '#D3D29C', // GRASSLANDS tan 
                        'Wetlands', '#689C9C', // WETLANDS blue-green 
                        'Salt-tolerant and/or succulent Shrublands', '#689C9C', // WETLANDS blue-green 
                        'No native vegetation recorded', '#000000', // WATER black 
                        '#222222' //other 
                    ],
                'fill-opacity': 0.75,
            }
    ...
    const swDrainSource = [
        { "drainID": "SW1", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.0, 1.87, 1.52, 1.04, 0.55, 0.17, 0.00, 0.09, 0.40, 0.87, 1.37, 1.78, 1.99, 1.94, 1.66, 1.21, 0.71, 0.28, 0.03, 0.03, 0.28, 0.70, 1.21, 1.66, 1.94, 1.99, 1.78, 1.38, 0.88, 0.41, 0.87, 1.37, 1.78] },
        { "drainID": "SW2", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.8, 2.65, 2.23, 1.65, 1.06, 0.61, 0.40, 0.51, 0.89, 1.45, 2.05, 2.53, 2.78, 2.73, 2.39, 1.86, 1.25, 0.74, 0.44, 0.44, 0.73, 1.24, 1.85, 2.39, 2.73, 2.78, 2.54, 2.05, 1.45, 0.89, 1.45, 2.05, 2.53] },
        { "drainID": "SW3", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.4, 2.29, 1.97, 1.54, 1.10, 0.75, 0.60, 0.68, 0.96, 1.38, 1.83, 2.20, 2.39, 2.35, 2.10, 1.69, 1.24, 0.85, 0.63, 0.63, 0.85, 1.23, 1.69, 2.09, 2.35, 2.39, 2.20, 1.84, 1.39, 0.97, 1.38, 1.83, 2.20] },
        { "drainID": "SW4", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.0, 1.87, 1.52, 1.04, 0.55, 0.17, 0.00, 0.09, 0.40, 0.87, 1.37, 1.78, 1.99, 1.94, 1.66, 1.21, 0.71, 0.28, 0.03, 0.03, 0.28, 0.70, 1.21, 1.66, 1.94, 1.99, 1.78, 1.38, 0.88, 0.41, 0.87, 1.37, 1.78] },
        { "drainID": "SW5", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.8, 2.65, 2.23, 1.65, 1.06, 0.61, 0.40, 0.51, 0.89, 1.45, 2.05, 2.53, 2.78, 2.73, 2.39, 1.86, 1.25, 0.74, 0.44, 0.44, 0.73, 1.24, 1.85, 2.39, 2.73, 2.78, 2.54, 2.05, 1.45, 0.89, 1.45, 2.05, 2.53] },
        { "drainID": "SW6", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.4, 2.29, 1.97, 1.54, 1.10, 0.75, 0.60, 0.68, 0.96, 1.38, 1.83, 2.20, 2.39, 2.35, 2.10, 1.69, 1.24, 0.85, 0.63, 0.63, 0.85, 1.23, 1.69, 2.09, 2.35, 2.39, 2.20, 1.84, 1.39, 0.97, 1.38, 1.83, 2.20] },
        { "drainID": "SW7", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.0, 1.87, 1.52, 1.04, 0.55, 0.17, 0.00, 0.09, 0.40, 0.87, 1.37, 1.78, 1.99, 1.94, 1.66, 1.21, 0.71, 0.28, 0.03, 0.03, 0.28, 0.70, 1.21, 1.66, 1.94, 1.99, 1.78, 1.38, 0.88, 0.41, 0.87, 1.37, 1.78] },
        { "drainID": "SW8", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.8, 2.65, 2.23, 1.65, 1.06, 0.61, 0.40, 0.51, 0.89, 1.45, 2.05, 2.53, 2.78, 2.73, 2.39, 1.86, 1.25, 0.74, 0.44, 0.44, 0.73, 1.24, 1.85, 2.39, 2.73, 2.78, 2.54, 2.05, 1.45, 0.89, 1.45, 2.05, 2.53] },
        { "drainID": "SW9", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.4, 2.29, 1.97, 1.54, 1.10, 0.75, 0.60, 0.68, 0.96, 1.38, 1.83, 2.20, 2.39, 2.35, 2.10, 1.69, 1.24, 0.85, 0.63, 0.63, 0.85, 1.23, 1.69, 2.09, 2.35, 2.39, 2.20, 1.84, 1.39, 0.97, 1.38, 1.83, 2.20] },
        { "drainID": "SW10", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.0, 1.87, 1.52, 1.04, 0.55, 0.17, 0.00, 0.09, 0.40, 0.87, 1.37, 1.78, 1.99, 1.94, 1.66, 1.21, 0.71, 0.28, 0.03, 0.03, 0.28, 0.70, 1.21, 1.66, 1.94, 1.99, 1.78, 1.38, 0.88, 0.41, 0.87, 1.37, 1.78] },
        { "drainID": "SW11", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.8, 2.65, 2.23, 1.65, 1.06, 0.61, 0.40, 0.51, 0.89, 1.45, 2.05, 2.53, 2.78, 2.73, 2.39, 1.86, 1.25, 0.74, 0.44, 0.44, 0.73, 1.24, 1.85, 2.39, 2.73, 2.78, 2.54, 2.05, 1.45, 0.89, 1.45, 2.05, 2.53] },
        { "drainID": "SW12", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.4, 2.29, 1.97, 1.54, 1.10, 0.75, 0.60, 0.68, 0.96, 1.38, 1.83, 2.20, 2.39, 2.35, 2.10, 1.69, 1.24, 0.85, 0.63, 0.63, 0.85, 1.23, 1.69, 2.09, 2.35, 2.39, 2.20, 1.84, 1.39, 0.97, 1.38, 1.83, 2.20] },
        { "drainID": "SW13", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.0, 1.87, 1.52, 1.04, 0.55, 0.17, 0.00, 0.09, 0.40, 0.87, 1.37, 1.78, 1.99, 1.94, 1.66, 1.21, 0.71, 0.28, 0.03, 0.03, 0.28, 0.70, 1.21, 1.66, 1.94, 1.99, 1.78, 1.38, 0.88, 0.41, 0.87, 1.37, 1.78] },
        { "drainID": "SW14", "status": "clear", "trigger": false, "blockageTimer": 0, "waterLevel": [2.8, 2.65, 2.23, 1.65, 1.06, 0.61, 0.40, 0.51, 0.89, 1.45, 2.05, 2.53, 2.78, 2.73, 2.39, 1.86, 1.25, 0.74, 0.44, 0.44, 0.73, 1.24, 1.85, 2.39, 2.73, 2.78, 2.54, 2.05, 1.45, 0.89, 1.45, 2.05, 2.53] },
    ];
    ...
    for (index in swDrainSource) {
        ...
        const blueThreshold = swDrainSource[index].waterLevel[0] * amplitudeMultiplier + amplitudeBaseline; //take the high tide and apply multipliers
    ...
    const clockDisplay = [
        'Midnight', '1 AM', '2 AM', '3 AM', '4 AM', '5 AM', '6 AM', '7 AM', '8 AM', '9 AM', '10 AM', '11 AM', 'noon', '1 PM', '2 PM', '3 PM', '4 PM', '5 PM', '6 PM', '7 AM', '8 AM', '9 PM', '10 PM', '11 PM'
    ];
    ...
    function loadStormwaterGame() {
        ...
        layersList = layersSubListCircles.concat(layersSubListSymbols);
        ...
        for (const index in layersSubListCircles) {
            map.addLayer({
                ...
                'paint': {
                    'circle-color': '#3277a8',
                    // 'circle-radius': 3,
                    'circle-radius': swDrainLive[index].waterLevel[0] * amplitudeMultiplier + amplitudeBaseline,
                    'circle-opacity': 1,
                },
                'layout': {
                    'visibility': 'visible' // we will set this to 'none' if this drain floods out
                },
                'filter': ['match', ['get', 'name'], layersSubListCircles[index], true, false],
            });
        };
    ...
    function startGame() {
        ...
        let gameAnimation = setInterval(() => {
            ...
            if ((globalStep - 15) % 80 === 0) { //every 12 intervals, starting at int 4
                blockDrain('SW1');}
            if ((globalStep - 24) % 70 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW8');}            
            if ((globalStep - 35) % 60 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW10');}
            if ((globalStep - 46) % 50 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW2');}
            if ((globalStep - 55) % 42 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW5');}
            if ((globalStep - 70) % 38 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW6');}
            if ((globalStep - 81) % 33 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW7');}
            if ((globalStep - 93) % 29 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW3');}
            if ((globalStep - 108) % 18 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW9');}
            if ((globalStep - 130) % 14 === 0) { //every 14 intervals, starting at int 7
                blockDrain('SW4');}
            ...
            for (const index in swDrainLive) {
                ...
                const thisCircleRadius = thisDrainWaterLevel * amplitudeMultiplier + amplitudeBaseline;
            ...
            for (const index in drainIdArray) {
                ...
                map.setPaintProperty(thisDrainID, 'circle-radius', swSymbolRadiusValues[index]);
                map.setPaintProperty(thisDrainID, 'circle-color', swSymbolColorValues[index]);
            };
    ...
    function blockDrain(drainID) {
        ...
        if (swDrainLive[drainIdIndex].status == 'clear') {        
            ...
            console.log(`Drain ${drainID} is BLOCKED: ${swDrainLive[drainIdIndex].status}`);
            ...
            for (const index in swDrainLive[drainIdIndex].waterLevel) {
                ...
                const waterLevelToUpdate = (indexNumber + globalStep) % swDrainLive[drainIdIndex].waterLevel.length;
                ...
                swDrainLive[drainIdIndex].waterLevel[waterLevelToUpdate] = swDrainLive[drainIdIndex].waterLevel[waterLevelToUpdate] + thisIncrementValue;
    ...
    function clearDrain(drainID) { 
        ...
        swDrainLive[drainIdIndex] = JSON.parse(JSON.stringify(swDrainSource[drainIdIndex]));
        
        // remove the QR code (white circle) from SYMBOL layer
        const swDrainSymbolLayerID = drainID + 'symbol';
        map.setLayoutProperty(swDrainSymbolLayerID, 'visibility', 'none');
        
        console.log(`Drain ${drainID} is CLEAR: ${swDrainLive[drainIdIndex].status}`);
    };
    ...
    function floodDrain(drainID) {
        ...
        console.log(`Drain ${drainID} is FLOODED: ${swDrainLive[drainIdIndex].status}`);
        
        // add splat animation on SYMBOL layer (remove QR code)
        const swDrainSymbolLayerID = drainID + 'symbol';
        map.setPaintProperty(swDrainSymbolLayerID, 'circle-color', 'rgba(252, 3, 3,0.6)');
    ...
    function activateMenu() {
        document.getElementById('presentationModeLayersBox').style.display = 'block';
        isMenuVisible = true;
    };
    ...
    function toggleLayersFromNumber(keyInput) {
        if (keyInput <= statesList.length) { // check if keyboard input number corresponds to a map state (if list <9)
    ...
    window.addEventListener('keydown', (event) => {
        ...
        if (stringDigits.includes(keyInput)) { //check if keyboard input is a number
